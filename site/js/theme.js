        ...
        (function()
            {
                var e="undefined" !=typeof window?window.jQuery:t(2); n.exports.ThemeNav=
                {
                    ...
                    , init:function(n)
                    {
                        n(document); var e=this; this.navBar=n("div.wy-side-scroll:first"), this.win=n(window), n(document).on("click", "[data-toggle='wy-nav-top']", (function()
                                ...
                                {
                                    var t=n(this); expand=n('<button class="toctree-expand" title="Open/close menu"></button>'), expand.on("click", (function(n)
                                            {
                    ...
                    , reset:function()
                    {
                        ...
                        {
                            var e=$(".wy-menu-vertical"), t=e.find('[href="' +n+'"]'); if(0===t.length)
                            {
                                var i=$('.document [id="' +n.substring(1)+'"]').closest("div.section"); 0===(t=e.find('[href="#' +i.attr("id")+'"]')).length&&(t=e.find('[href="#"]'))
                            }

                            //if(t.length>0)
                            //{
                            //    $(".wy-menu-vertical .current").removeClass("current").attr("aria-expanded", "false"), t.addClass("current").attr("aria-expanded", "true"), t.closest("li.toctree-l1").parent().addClass("current").attr("aria-expanded", "true"); for(let n=1; n<=10; n++)t.closest("li.toctree-l" +n).addClass("current").attr("aria-expanded", "true"); t[0].scrollIntoView()
                            //}
                        }
                    ...
                    , onScroll:function()
                    {
                        this.winScroll= !1; var n=this.win.scrollTop(), e=n+this.winHeight, t=this.navBar.scrollTop()+(n-this.winPosition); n<0||e>this.docHeight||(this.navBar.scrollTop(t), this.winPosition=n)
                    }
                    ...
                    , toggleCurrent:function(n)
                    {
                        ...
                        if( t.length )
                        {
                            t.removeClass("current").attr("aria-expanded", "false"), e.toggleClass("current").attr("aria-expanded", (function(n, e)
                            {
                ...
                , "undefined" !=typeof window&&(window.SphinxRtdTheme=
                    {
                        Navigation:n.exports.ThemeNav, StickyNav:n.exports.ThemeNav
                    }
